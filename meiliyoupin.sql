...
create table goods(
    ...
    shop_price decimal default 0,
    market_price decimal default 0,
    ...
    create table users(
        ...
        user_word varchar(255) default '',
        user_money decimal default 0,
        lock_money decimal default 0,  #冻结资金
        user_points int default 0,   #消费积分
        real_name varchar(255) default '',
        virtual_money int default 0, # 代金券
    ...
    create table carts (
        ...
        shop_price decimal default 0,
        goods_number int default 0,
        goods_attr varchar(255) default '',
        thumb_img varchar(255) default "",
        is_groupon int default 0,
        shipping_free int default 0,
    ...
    create table orders(
        id int auto_increment primary key,
        user_id int default 0,
        order_sn varchar(255) default 0,
        order_status int default 0,
        shipping_status int default 0,
        pay_status int default 0,
        consignee varchar(255) default '',
        ...
        goods_amount decimal default 0,
        shipping_fee decimal default 0,
        money_paid decimal default 0,
        user_money decimal default 0,
        virtual_money int default 0,
        bonus_id int default 0,
        order_amount decimal default 0,
        add_time varchar(255) default 0,
        confirm_time varchar(255) default 0,
        pay_time varchar(255) default 0,
        shipping_time varchar(255) default 0
...
###### shipping_type 配送方式
    create table shipping_type(
        id int auto_increment primary key,
        shipping_name varchar(255) default 0,
        shipping_code varchar(255) default 0,
        shipping_desc varchar(255) default 0,
        enabled int default 1,
        shipping_print text ,
        print_bg varchar(255) default 0,
        shiping_config text
        )engine=myisam default charset=utf8;

###### shipping_area 配送区域配置表
    create table shipping_area (
        id int auto_increment primary key,
        shipping_area_name varchar(255) default '',
        shipping_id int default 0,
        configure text
        )engine=myisam default charset=utf8;


###### area_region 配送区域价格关联表
    create table area_region (
        id int auto_increment primary key,
        shipping_area_id int default 0,
...
insert into admin_menu(parent_id,menu_name,menu_url)
values
(5,"会员列表","index.php?act=users_list"),
(5,"添加会员","index.php?act=users_add"),
(5,"会员等级","index.php?act=users_level_list"),
(5,"添加等级","index.php?act=users_level_add")
;


###评论管理
insert into admin_menu(parent_id,menu_name,menu_url)
values(6,"评论列表","index.php?act=goods_comment"),
(6,"留言管理","index.php?act=user_message");
...
INSERT INTO `region` VALUES ('3410', '13', '赤壁', '2', '0');
INSERT INTO `region` VALUES ('3412', '386', '义乌市', '3', '0');
INSERT INTO `region` VALUES ('3413', '29', '乌苏市', '2', '0');
INSERT INTO `region` VALUES ('3415', '169', '加格达奇', '3', '0');
INSERT INTO `region` VALUES ('3416', '295', '高技术产业开发区', '3', '0');
INSERT INTO `region` VALUES ('3417', '95', '黄圃大雁工业区', '3', '0');
INSERT INTO `region` VALUES ('3418', '284', '蓝村镇', '3', '0');
INSERT INTO `region` VALUES ('3419', '95', '小榄镇', '3', '0');