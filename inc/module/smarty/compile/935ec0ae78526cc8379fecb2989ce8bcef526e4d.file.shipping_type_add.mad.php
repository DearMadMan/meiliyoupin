<?php /* Smarty version Smarty-3.1.16, created on 2014-07-21 15:29:44
         compiled from "E:\apache\www\temp\d\madadmin\template\shipping_type_add.mad" */ ?>
<?php /*%%SmartyHeaderCode:1700153ccc07075afc5-03124847%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '935ec0ae78526cc8379fecb2989ce8bcef526e4d' => 
    array (
      0 => 'E:\\apache\\www\\temp\\d\\madadmin\\template\\shipping_type_add.mad',
      1 => 1405927781,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1700153ccc07075afc5-03124847',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_53ccc0707da405_58424482',
  'variables' => 
  array (
    'vp' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_53ccc0707da405_58424482')) {function content_53ccc0707da405_58424482($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
                    ...
                    <div class="row-fluid">
                        <div class="widget-box">
                            ...
                            <div class="widget-content nopadding">
                                <form action="post.php?act=shipping_type_add" method="POST" enctype='multipart/form-data' class="form-horizontal">
                                    <div class="control-group">
                                        <label class="control-label">配送方式名称</label>
                                        <div class="controls">
                                            <input name="shipping_name" type="text" class="span11" placeholder="配送方式名称">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">配送方式代码</label>
                                        <div class="controls">
                                            <input name="shipping_code" type="text" class="span11" placeholder="配送方式代码">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">配送方式简介</label>
                                        <div class="controls">
                                            <input name="shipping_desc" type="text" class="span11" placeholder="配送方式简介">
                                        </div>
                                    </div>
                                    <!--
                                    <div class="control-group">
