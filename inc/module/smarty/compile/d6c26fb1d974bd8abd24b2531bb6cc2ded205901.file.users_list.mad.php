<?php /* Smarty version Smarty-3.1.16, created on 2014-07-17 14:08:02
         compiled from "E:\apache\www\temp\d\madadmin\template\users_list.mad" */ ?>
<?php /*%%SmartyHeaderCode:2022453c491800f1676-48403403%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd6c26fb1d974bd8abd24b2531bb6cc2ded205901' => 
    array (
      0 => 'E:\\apache\\www\\temp\\d\\madadmin\\template\\users_list.mad',
      1 => 1405577134,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2022453c491800f1676-48403403',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_53c49180505220_97978203',
  'variables' => 
  array (
    'vp' => 0,
    'users_list' => 0,
...
<?php if ($_valid && !is_callable('content_53c49180505220_97978203')) {function content_53c49180505220_97978203($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'E:\\apache\\www\\temp\\d\\inc\\module\\smarty\\plugins\\modifier.date_format.php';
?><!DOCTYPE html>
<html lang="en">
...
<h5>全局设置</h5>
 ...
 <div class="widget-content nopadding ">
        <form class="form-horizontal" action="index.php?act=users_list" method="post">
...
?>
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['v']->value['user_name'], ENT_QUOTES, 'UTF-8', true);?>
</td>
                                    <td><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['v']->value['user_email'], ENT_QUOTES, 'UTF-8', true);?>
</td>
                                     <td><?php echo sprintf("%.2f",$_smarty_tpl->tpl_vars['v']->value['user_money']);?>
</td>
                                      <td><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['v']->value['user_points'], ENT_QUOTES, 'UTF-8', true);?>
</td>
                                       <td><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['v']->value['virtual_money'], ENT_QUOTES, 'UTF-8', true);?>
</td>
                                    <td><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['v']->value['reg_time'],"%Y-%m-%d");?>
</td>
                                    <td>
                                        <a href="index.php?act=users_edit&id=<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
"> <i class="icon-edit"></i>
                                            编辑
                                        </a>
                                        &nbsp;
                                        <a href="index.php?act=users_delete&id=<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" onclick="if(!confirm('确定要删除该文会员吗？不可修复'))return false;">
            ...
            <?php if ($_smarty_tpl->tpl_vars['more']->value) {?>
                <div class="dataTables_paginate fg-buttonset ui-buttonset fg-buttonset-multi ui-buttonset-multi paging_full_numbers" id="DataTables_Table_0_paginate">
                    <a tabindex="0" class="first ui-corner-tl ui-corner-bl fg-button ui-button ui-state-default <?php if ($_smarty_tpl->tpl_vars['now']->value==1) {?>ui-state-disabled<?php }?>" id="DataTables_Table_0_first" href="<?php if ($_smarty_tpl->tpl_vars['now']->value==1) {?>javascript:;<?php } else { ?>index.php?act=users_list&pageNow=1<?php }?>"  >First</a>
                    <a tabindex="0" class="previous fg-button ui-button ui-state-default" id="DataTables_Table_0_previous <?php if ($_smarty_tpl->tpl_vars['now']->value==1) {?>ui-state-disabled<?php }?>" href="<?php if ($_smarty_tpl->tpl_vars['now']->value==1) {?>javascript:;<?php } else { ?>index.php?act=users_list&pageNow=<?php echo $_smarty_tpl->tpl_vars['pre']->value;?>
<?php }?>">Previous</a>
                    <span>
...
$_smarty_tpl->tpl_vars['foo']->first = $_smarty_tpl->tpl_vars['foo']->iteration == 1;$_smarty_tpl->tpl_vars['foo']->last = $_smarty_tpl->tpl_vars['foo']->iteration == $_smarty_tpl->tpl_vars['foo']->total;?>
                          <a href="<?php if ($_smarty_tpl->tpl_vars['foo']->value==$_smarty_tpl->tpl_vars['now']->value) {?>javascript:;<?php } else { ?> index.php?act=users_list&pageNow=<?php echo $_smarty_tpl->tpl_vars['foo']->value;?>
...
<?php }?>" tabindex="0" class="fg-button ui-button ui-state-default <?php if ($_smarty_tpl->tpl_vars['foo']->value==$_smarty_tpl->tpl_vars['now']->value) {?>ui-state-disabled<?php }?> "><?php echo $_smarty_tpl->tpl_vars['foo']->value;?>
                    ...
                    <a tabindex="0" class="next fg-button ui-button ui-state-default  <?php if ($_smarty_tpl->tpl_vars['now']->value==$_smarty_tpl->tpl_vars['last']->value) {?>ui-state-disabled<?php }?>" id="DataTables_Table_0_next" href="<?php if ($_smarty_tpl->tpl_vars['now']->value==$_smarty_tpl->tpl_vars['last']->value) {?>javascript:;<?php } else { ?>index.php?act=users_list&pageNow=<?php echo $_smarty_tpl->tpl_vars['next']->value;?>
<?php }?>">Next</a>
                    <a tabindex="0" class="last ui-corner-tr ui-corner-br fg-button ui-button ui-state-default <?php if ($_smarty_tpl->tpl_vars['now']->value==$_smarty_tpl->tpl_vars['last']->value) {?>ui-state-disabled<?php }?>" id="DataTables_Table_0_last"  href="<?php if ($_smarty_tpl->tpl_vars['now']->value==$_smarty_tpl->tpl_vars['last']->value) {?>javascript:;<?php } else { ?>index.php?act=users_list&pageNow=<?php echo $_smarty_tpl->tpl_vars['last']->value;?>
<?php }?>">Last</a>
                </div>
    <?php }?>
            </div>
